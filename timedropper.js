//codes originally from http://www.jq22.com/jquery-info7815, and modified for part of the function
(function($) {
            ...
            var _td_init = function(value) {
                ...
                if (_td_input.val().length && !_td_options.setCurrentTime) {
                    ...
                    if (st) {
                        ...
                        if (!parseInt(_td_span_h.text())) h = _td_num(_td_options.modifyTime?_td_options.hour:d.getHours());
                        else h = _td_num(_td_span_h.text());
                        if (!parseInt(_td_span_m.text())) m = _td_num(_td_options.modifyTime?_td_options.minute:d.getMinutes());
